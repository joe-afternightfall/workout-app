...
export const CATEGORY_TYPES_ROUTE = `${BASE_CONFIG_ROUTE}/category-types`;
export const WORKOUTS_ROUTE = '/workouts';
export const USER_PROFILES_ROUTE = '/user-profiles';
export const CIRCUIT_TEMPLATES_ROUTE = '/circuit-templates';
